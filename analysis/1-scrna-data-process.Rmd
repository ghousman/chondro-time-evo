...
## Run Cell Ranger multi + count to process data
...
sbatch ./../chondro-time-evo/code/cellranger.batch1.h.sh
sbatch ./../chondro-time-evo/code/cellranger.batch2.h.sh

#process reads using chimp genome and ortho exon annotation
cd /project2/gilad/ghousman/chondro-human-chimp/hc-chondro-time/scRNA
sbatch ./../chondro-time-evo/code/cellranger.batch1.c.sh
sbatch ./../chondro-time-evo/code/cellranger.batch2.c.sh

### NEED TO FIX STARTING HERE ###
### SEGMENTATION FAULT - SAME ISSUE AS ABOVE ###
### NEED TO FIX STARTING HERE ###

#process reads using human/chimp combined genome and ortho exon annotation
cd /project2/gilad/ghousman/chondro-human-chimp/hc-chondro-time/scRNA
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-01
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-02
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-03
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-04
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-05
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-06
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-07
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-08
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-09
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-10
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-11
sbatch ./../chondro-time-evo/code/cellranger.batch1.hc.sh YG-GH-20S-10X-GH-12
cd /project2/gilad/ghousman/chondro-human-chimp/hc-chondro-time/scRNA
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-01
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-02
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-03
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-04
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-05
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-06
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-07
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-08
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-09
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-10
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-11
sbatch ./../chondro-time-evo/code/cellranger.batch2.hc.sh YG-GH-20S-10X-GH-12

```


## Examine multi output
...
#compare cellplex assigments using 0.9 threshold vs. 0.5 threshold
...
#compare cellplex assigments using human reference vs. chimp reference
...
For now, go with cell counts using 0.5 threshold and human reference

batch 1 = 31,562 (vs. 31,697)
batch 2 =  7,241 (vs.  7,451)

```{r}

dim(barcode_assign_b1)
count(barcode_assign_b1, HumanRef_0.5)
count(barcode_assign_b1, ChimpRef_0.5)

dim(barcode_assign_b2)
count(barcode_assign_b2, HumanRef_0.5)
count(barcode_assign_b2, ChimpRef_0.5)
