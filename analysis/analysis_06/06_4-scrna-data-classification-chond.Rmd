...
* data integrated across individuals - chond (conservative cell filter + intra-dataset variable genes + regress out UMI/mito
* data integrated across individuals - chond (conservative cell filter + non-zero genes + regress out UMI/mito)
...
table(subset(data,subset=ChondroStage=="Day 00")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=ChondroStage=="Day 0")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=ChondroStage=="Day 7")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=ChondroStage=="Day 14")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="Day 00"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="Day 0"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="Day 7"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="Day 14"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="Day 00"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="Day 0"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="Day 7"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="Day 14"))@meta.data$integrated_snn_res.0.25)
...
CombinePlots(plots=list((DimPlot(subset(data,subset=ChondroStage=="Day 00"), split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2")),
                        (DimPlot(subset(data,subset=ChondroStage=="Day 0"),  split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2")),
                        (DimPlot(subset(data,subset=ChondroStage=="Day 7"),  split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2")),
                        (DimPlot(subset(data,subset=ChondroStage=="Day 14"), split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2"))),
             ncol=1)
...
#save data
saveRDS(integrate, file=paste0("./data/integrated/06_combined-data-wu-human.filterC.log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
