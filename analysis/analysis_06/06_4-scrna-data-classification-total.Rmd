...
# scRNA-seq Analyses - Cell Classification
...
* data integrated across individuals - total (conservative cell filter + intra-dataset variable genes + regress out UMI/mito
...
#Load data
scrna <- paste0("./data/integrated/06_data",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds")
data <- readRDS(scrna)
...
## Seurat Clustering
                               ...
                               Var.cca.50.reg    No0.cca.50.reg
data, k=40, res=1.00 clusters:             19
data, k=40, res=0.75 clusters:             14
data, k=40, res=0.50 clusters:             12
data, k=40, res=0.25 clusters:              8
data, k=40, res=0.10 clusters:              4
data, k=40, res=0.05 clusters:              4
...
saveRDS(data, file=paste0("./data/integrated/06_data",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".assign.rds"))
...
#fix stage labels
data$Stage[which(data$Stage=="d7-m")] <- "d7.m"
data$Stage[which(data$Stage=="d14-m")] <- "d14.m"
data$Stage[which(data$Stage=="d7-c")] <- "d7.c"
data$Stage[which(data$Stage=="d14-c")] <- "d14.c"
...
Calculate numbers of cells in each cluster (resolution=0.25) given particular parameters.
...
table(data@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=Species=="Human")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=Species=="Chimp")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=Stage=="d00")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=Stage=="d0")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=Stage=="d7-m")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=Stage=="d14-m")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=Stage=="d7-c")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=Stage=="d14-c")@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="d00"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="d0"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="d7-m"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="d14-m"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="d7-c"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Human" & ChondroStage=="d14-c"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="d00"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="d0"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="d7-m"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="d14-m"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="d7-c"))@meta.data$integrated_snn_res.0.25)
table(subset(data,subset=(Species=="Chimp" & ChondroStage=="d14-c"))@meta.data$integrated_snn_res.0.25)
...
#x <- "integrated_snn_res.0.75"
#x <- "integrated_snn_res.1"
...
CombinePlots(plots=list((DimPlot(subset(data,subset=Stage=="d00"), split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2")),
                        (DimPlot(subset(data,subset=Stage=="d0"),  split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2")),
                        (DimPlot(subset(data,subset=Stage=="d7-m"),  split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2")),
                        (DimPlot(subset(data,subset=Stage=="d14-m"), split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2")),
                        (DimPlot(subset(data,subset=Stage=="d7-c"),  split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2")),
                        (DimPlot(subset(data,subset=Stage=="d14-c"), split.by=x, reduction="umap") + labs(x="UMAP1",y="UMAP2"))),
             ncol=1)

```

Define new metadata label for general clusters (resolution=0.25) and chondrogenic clusters (resolution=0.75).

```{r, eval=FALSE}

#resolution=0.25
data <- AddMetaData(data, rep(NA,length(rownames(data@meta.data))), col.name="Cluster0.25")
data$Cluster0.25[which(data$integrated_snn_res.0.25=="3")]  <- "MSC.c1"
data$Cluster0.25[which(data$integrated_snn_res.0.25=="2")]  <- "MSC.c2"
data$Cluster0.25[which(data$integrated_snn_res.0.25=="0")]  <- "MSC.c3"
data$Cluster0.25[which(data$integrated_snn_res.0.25=="1")]  <- "Chondrogenic.c1"
data$Cluster0.25[which(data$integrated_snn_res.0.25=="4")]  <- "Chondrogenic.c2"

#resolution=0.75
data <- AddMetaData(data, rep(NA,length(rownames(data@meta.data))), col.name="Cluster0.75")
data$Cluster0.75[which(data$integrated_snn_res.0.75=="5")]  <- "MSC.c1"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="0")]  <- "MSC.c2"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="6")]  <- "MSC.c3"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="2")]  <- "MSC.c4"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="4")]  <- "MSC.c5"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="9")]  <- "MSC.c6"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="10")] <- "MSC.c7"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="1")]  <- "Chondrogenic.c1"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="3")]  <- "Chondrogenic.c2"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="7")]  <- "Chondrogenic.c3"
data$Cluster0.75[which(data$integrated_snn_res.0.75=="8")]  <- "Chondrogenic.c4"
...
#resolution=0.75
data <- AddMetaData(data, rep(NA,length(rownames(data@meta.data))), col.name="ChondroCluster0.75")
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="5")]  <- "not chondrogenic"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="0")]  <- "not chondrogenic"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="6")]  <- "not chondrogenic"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="2")]  <- "not chondrogenic"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="4")]  <- "not chondrogenic"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="9")]  <- "not chondrogenic"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="10")] <- "not chondrogenic"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="1")]  <- "Chondrogenic.c1"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="3")]  <- "Chondrogenic.c2"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="7")]  <- "Chondrogenic.c3"
data$ChondroCluster0.75[which(data$integrated_snn_res.0.75=="8")]  <- "Chondrogenic.c4"
...
saveRDS(markers, file=paste0("./output/markers0.05.data.filterC.log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".assign.rds"))
...
cd /project2/gilad/ghousman/chondro-human-chimp/hc-chondro-time/chondro-time-evo/code/findmarkers/
sbatch --account=pi-gilad ./FindMarkers.sh 0.10 Var cca 50 reg
sbatch --account=pi-gilad ./FindMarkers.sh 0.25 Var cca 50 reg
sbatch --account=pi-gilad ./FindMarkers.sh 0.50 Var cca 50 reg
sbatch --account=pi-gilad ./FindMarkers.sh 0.75 Var cca 50 reg
sbatch --account=pi-gilad ./FindMarkers.sh 1.00 Var cca 50 reg
```


## Integrate with External Dataset (Kenneth iPSC-derived EBs)

Integrate current study data with Kenneth's iPSC-derived EB data (total)
...
set <- "total-ind"  #all chondrogenic cells
...
#add stage metadata
eb_data$Stage <- "KB: iPSC-EB"

obj <- append(organoid_data,eb_data)
rm(organoid_data,eb_data)
...
#save data
saveRDS(integrate, file=paste0("./data/integrated/06_combined-data-eb",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
...
#visualize data
integrate <- readRDS(file=paste0("./data/integrated/06_combined-data-eb",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
DimPlot(integrate,
        group.by="Stage",
        reduction="umap") +
  labs(x="UMAP1",y="UMAP2")
...
Integrate current study data with Kenneth's iPSC-derived EB data (human only)
...
## Integrate with External Dataset (Wu et al. 2021)

Chondrogenic Dataset from Wu et al. (2021) Nature Communications
...
#Anthony Hung initially downloaded Wu et al. (2021) data from GEO (Series GSE160625), which includes single-cell data from an iPSC-derived chondrogenic pellet differentiation time course study. Data include barcodes, genes, and count matrices from samples taken from iPSCs and samples from 7, 14, 28, and 42 day chondrogenic pellets treated with chondrogenic media containing a WNT and MITF inhibitor.
...
wu_d7_seurat <- Seurat::AddMetaData(wu_d7_seurat, "Wu: Day 7", col.name="ChondroStage")
wu_d7_seurat
rm(count_data_wu_d7,genes_wu_d7,barcodes_wu_d7)
...
wu_d14_seurat <- Seurat::AddMetaData(wu_d14_seurat, "Wu: Day 14", col.name="ChondroStage")
wu_d14_seurat
rm(count_data_wu_d14,genes_wu_d14,barcodes_wu_d14)
...
wu_d28_seurat <- Seurat::AddMetaData(wu_d28_seurat, "Wu: Day 28", col.name="ChondroStage")
wu_d28_seurat
rm(count_data_wu_d28,genes_wu_d28,barcodes_wu_d28)
...
wu_d42_seurat <- Seurat::AddMetaData(wu_d42_seurat, "Wu: Day 42", col.name="ChondroStage")
wu_d42_seurat
rm(count_data_wu_d42,genes_wu_d42,barcodes_wu_d42)

wu_combined_rev <- merge(wu_d7_seurat, y=c(wu_d14_seurat, wu_d28_seurat, wu_d42_seurat), project="wu")
wu_combined_rev
rm(wu_d7_seurat,wu_d14_seurat,wu_d28_seurat,wu_d42_seurat)
...
wu_combined_rev <- subset(wu_combined_rev, subset=(percent.mt<25 & nCount_RNA>1000 & nCount_RNA<60000 & nFeature_RNA>250 & nFeature_RNA<7500))
wu_combined_rev

saveRDS(wu_combined_rev, file="./data/external/wu_combined_rev.rds")
rm(wu_combined_rev)

```

Integrate current study data with Wu data (total)
...
#add stage metadata
wu_data$Stage <- wu_data$ChondroStage
...
Integrate current study data with Wu data (human only)
...
obj <- append(organoid_data_human,wu_data)
rm(organoid_data,organoid_data_human,wu_data)
...
#save data
saveRDS(integrate, file=paste0("./data/integrated/06_combined-data-wu-human",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
...
#visualize data
integrate <- readRDS(file=paste0("./data/integrated/06_combined-data-wu-human",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
DimPlot(integrate,
        group.by="Stage",
        reduction="umap") +
  labs(x="UMAP1",y="UMAP2")
...
## Integrate with External Dataset (GAH Pilot)

Pilot GAH iPSC/MSC/Osteogenic/Chondrogenic Monolayer Differentiation Dataset

```{r}

#Pilot differentiations that GAH performed in the Gilad lab with human (H1, H23555) and chimp (C1, C8861) samples

count_data_gah <- read.csv("/project2/gilad/ghousman/skeletal-human-chimp/human-chimp-skeletal-scRNA/data/cellranger-data-full/GHO_count.csv")
meta_data_gah <- read.csv("/project2/gilad/ghousman/skeletal-human-chimp/human-chimp-skeletal-scRNA/data/cellranger-data-full/GHO_meta.csv")
rownames(meta_data_gah) <- str_replace(rownames(meta_data_gah),"-",".")

gah_data <- CreateSeuratObject(counts=count_data_gah, meta.data=meta_data_gah, project="gah")
rm(count_data_gah,meta_data_gah)

gah_data$ChondroStage <- NA
gah_data$ChondroStage[which(gah_data$Cell.Type=="iPSC")]         <- "GH: iPSC"
gah_data$ChondroStage[which(gah_data$Cell.Type=="MSC")]          <- "GH: Day 00"
gah_data$ChondroStage[which(gah_data$Cell.Type=="Osteogenic")]   <- "GH: Osteo"
gah_data$ChondroStage[which(gah_data$Cell.Type=="Chondrogenic")] <- "GH: Day 21*"

#filter data
#gah_data <- subset(gah_data, subset=percent.mt < 5)
gah_data <- subset(gah_data, subset=(percent.mt<25 & nCount_RNA>1000 & nCount_RNA<60000 & nFeature_RNA>250 & nFeature_RNA<7500))
dim(gah_data)

saveRDS(gah_data, file="./data/external/gah_data.rds")

#isolate just chondrogenic cells
gah_data_chondro <- subset(gah_data, subset=ChondroStage=="GH: Day 21*")
dim(gah_data_chondro)
saveRDS(gah_data_chondro, file="./data/external/gah_data_chondro.rds")

#isolate just osteogenic cells
gah_data_osteo <- subset(gah_data, subset=ChondroStage=="GH: Osteo")
dim(gah_data_osteo)
saveRDS(gah_data_osteo, file="./data/external/gah_data_osteo.rds")

#isolate just chondrogenic cells + osteogenic cells
gah_data_chondroosteo <- subset(gah_data, subset=(ChondroStage=="GH: Day 21*" | ChondroStage=="GH: Osteo"))
dim(gah_data_chondroosteo)
saveRDS(gah_data_chondroosteo, file="./data/external/gah_data_chondroosteo.rds")

rm(gah_data,gah_data_chondro)

```

Integrate current study data with pilot differentiation data (total)
...
organoid_data <- readRDS(paste0("./data/06_data",filter,".log.",set,".rds"))
gah_data  <- readRDS("./data/external/gah_data.rds")

#add stage metadata
gah_data$Stage <- gah_data$ChondroStage

#subset gah data by individuals
gah_data_h1 <- subset(gah_data, subset=Individual=="H1")
gah_data_c1 <- subset(gah_data, subset=Individual=="C1")

#obj <- append(organoid_data,gah_data)
obj <- append(append(organoid_data,gah_data_h1),gah_data_c1)

rm(organoid_data,gah_data,gah_data_h1,gah_data_c1)
...
#save data
saveRDS(integrate, file=paste0("./data/integrated/06_combined-data-gah",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
...
#visualize data
integrate <- readRDS(file=paste0("./data/integrated/06_combined-data-gah",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
DimPlot(integrate,
        group.by="Stage",
        reduction="umap") +
  labs(x="UMAP1",y="UMAP2")
...
Integrate current study data with pilot differentiation data (chondro only)
...
organoid_data <- readRDS(paste0("./data/06_data",filter,".log.",set,".rds"))
gah_data  <- readRDS("./data/external/gah_data_chondro.rds")
...
#save data
saveRDS(integrate, file=paste0("./data/integrated/06_combined-data-gah-chondro",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
...
#visualize data
integrate <- readRDS(file=paste0("./data/integrated/06_combined-data-gah-chondro",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
DimPlot(integrate,
        group.by="Stage",
        reduction="umap") +
  labs(x="UMAP1",y="UMAP2")
...
Integrate current study data with pilot differentiation data (osteo only)
...
organoid_data <- readRDS(paste0("./data/06_data",filter,".log.",set,".rds"))
gah_data  <- readRDS("./data/external/gah_data_osteo.rds")
...
#save data
saveRDS(integrate, file=paste0("./data/integrated/06_combined-data-gah-osteo",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
...
#visualize data
integrate <- readRDS(file=paste0("./data/integrated/06_combined-data-gah-osteo",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
DimPlot(integrate,
        group.by="Stage",
        reduction="umap") +
  labs(x="UMAP1",y="UMAP2")
...
Integrate current study data with pilot differentiation data (chondro+osteo only)
...
organoid_data <- readRDS(paste0("./data/06_data",filter,".log.",set,".rds"))
gah_data  <- readRDS("./data/external/gah_data_chondroosteo.rds")
...
#save data
saveRDS(integrate, file=paste0("./data/integrated/06_combined-data-gah-chondroosteo",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
...
#visualize data
integrate <- readRDS(file=paste0("./data/integrated/06_combined-data-gah-chondroosteo",filter,".log.",set,".int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
DimPlot(integrate,
        group.by="Stage",
        reduction="umap") +
  labs(x="UMAP1",y="UMAP2")
