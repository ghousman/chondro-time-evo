...
x_2 <- cp_threshold_assignment(data=x, threshold=0.9)
barcode_assign_b1 <- merge(x[,c("Barcode","Assignment","Assignment_Probability")], x_2[,c(2:4)], by="Barcode")
colnames(barcode_assign_b1)[2:5] <- c("HumanRef_0.6","HumanRef_0.6_AssignProb","HumanRef_0.9","HumanRef_0.9_AssignProb")
...
colnames(barcode_assign_b1)[6:9] <- c("ChimpRef_0.6","ChimpRef_0.6_AssignProb","ChimpRef_0.9","ChimpRef_0.9_AssignProb")
...
colnames(barcode_assign_b2)[2:5] <- c("HumanRef_0.6","HumanRef_0.6_AssignProb","HumanRef_0.9","HumanRef_0.9_AssignProb")
...
colnames(barcode_assign_b2)[6:9] <- c("ChimpRef_0.6","ChimpRef_0.6_AssignProb","ChimpRef_0.9","ChimpRef_0.9_AssignProb")
...
#(1)load data
raw_data <- Read10X(data="./../scRNA/human_chimp_chondro_time_batch1_h_06/outs/multi/count/raw_feature_bc_matrix")

#(2)create seurat objects
data <- CreateSeuratObject(counts=raw_data$`Gene Expression`)

#(3)view details of seurat objects
data #19377 features, 3274414 samples

#(4)add percent of mitochondrial reads to metadata
which(sapply(data@assays$RNA@counts@Dimnames[[1]], stri_count_regex, pattern="MT-")==1) #no MT-CYB
...
data <- AddMetaData(data, barcode_assign_b1[m,]$HumanRef_0.6, col.name="CellPlex_HumanRef_0.6")
data <- AddMetaData(data, barcode_assign_b1[m,]$HumanRef_0.9, col.name="CellPlex_HumanRef_0.9")
data <- AddMetaData(data, barcode_assign_b1[m,]$HumanRef_0.6_AssignProb, col.name="CellPlex_HumanRef_0.6_AssignProb")
data <- AddMetaData(data, barcode_assign_b1[m,]$HumanRef_0.9_AssignProb, col.name="CellPlex_HumanRef_0.9_AssignProb")

#(6)plot QC metrics
table(data@meta.data$CellPlex_HumanRef_0.6)
table(data@meta.data$CellPlex_HumanRef_0.9)

VlnPlot(data,
        features=c("nFeature_RNA","nCount_RNA","percent.mt"),
        group.by="CellPlex_HumanRef_0.6",
        ncol=1,
        pt.size=0,
        #stack=TRUE
        )
mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6 %in% cmo)])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO301")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO302")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO303")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO304")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO305")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO306")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO307")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO308")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO309")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO310")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO311")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO312")])
...
#(1)load data
raw_data <- Read10X(data="./../scRNA/human_chimp_chondro_time_batch1_c_06/outs/multi/count/raw_feature_bc_matrix")
...
m <- match(rownames(data@meta.data),barcode_assign_b1$Barcode)
if(any(is.na(m))) cat("Not all barcodes are in data.\n")
data <- AddMetaData(data, barcode_assign_b1[m,]$ChimpRef_0.6, col.name="CellPlex_ChimpRef_0.6")
data <- AddMetaData(data, barcode_assign_b1[m,]$ChimpRef_0.9, col.name="CellPlex_ChimpRef_0.9")
data <- AddMetaData(data, barcode_assign_b1[m,]$ChimpRef_0.6_AssignProb, col.name="CellPlex_ChimpRef_0.6_AssignProb")
data <- AddMetaData(data, barcode_assign_b1[m,]$ChimpRef_0.9_AssignProb, col.name="CellPlex_ChimpRef_0.9_AssignProb")

#(6)plot QC metrics
table(data@meta.data$CellPlex_ChimpRef_0.6)
table(data@meta.data$CellPlex_ChimpRef_0.9)

VlnPlot(data,
        features=c("nFeature_RNA","nCount_RNA","percent.mt"),
        group.by="CellPlex_ChimpRef_0.6",
        ncol=1,
        pt.size=0,
        #stack=TRUE
        )
mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6 %in% cmo[1:6])])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO301")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO302")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO303")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO304")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO305")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO306")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO307")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO308")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO309")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO310")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO311")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_ChimpRef_0.6=="CMO312")])
...
#(1)load data
raw_data <- Read10X(data="./../scRNA/human_chimp_chondro_time_batch2_h_06/outs/multi/count/raw_feature_bc_matrix")
...
if(any(is.na(m))) cat("Not all barcodes are in data.\n")
data <- AddMetaData(data, barcode_assign_b2[m,]$HumanRef_0.6, col.name="CellPlex_HumanRef_0.6")
data <- AddMetaData(data, barcode_assign_b2[m,]$HumanRef_0.9, col.name="CellPlex_HumanRef_0.9")
data <- AddMetaData(data, barcode_assign_b2[m,]$HumanRef_0.6_AssignProb, col.name="CellPlex_HumanRef_0.6_AssignProb")
...
mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6 %in% cmo[1:6])])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO301")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO302")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO303")])
#mean(data@meta.data$nCount_RNA[which(data@meta.data$CellPlex_HumanRef_0.6=="CMO304")])
...
#(1)load data
raw_data <- Read10X(data="./../scRNA/human_chimp_chondro_time_batch2_c_06/outs/multi/count/raw_feature_bc_matrix")
...
m <- match(rownames(data@meta.data),barcode_assign_b2$Barcode)
if(any(is.na(m))) cat("Not all barcodes are in data.\n")
data <- AddMetaData(data, barcode_assign_b2[m,]$ChimpRef_0.6, col.name="CellPlex_ChimpRef_0.6")
data <- AddMetaData(data, barcode_assign_b2[m,]$ChimpRef_0.9, col.name="CellPlex_ChimpRef_0.9")
data <- AddMetaData(data, barcode_assign_b2[m,]$ChimpRef_0.6_AssignProb, col.name="CellPlex_ChimpRef_0.6_AssignProb")
