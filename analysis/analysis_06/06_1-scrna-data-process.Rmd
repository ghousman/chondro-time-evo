...
Processed data using CMO threshold of 0.6 (instead of the default of 0.9)
...
x <- read.csv("../scRNA/human_chimp_chondro_time_batch1_h_06/outs/multi/multiplexing_analysis/assignment_confidence_table.csv")
dim(x)
dplyr::count(x, Assignment)
x_2 <- cp_threshold_assignment(data=x, threshold=0.5)
dim(x_2)
dplyr::count(x_2, Assigned_Tags)
x_3 <- cp_threshold_assignment(data=x, threshold=0.9)
dim(x_3)
dplyr::count(x_3, Assigned_Tags)
barcode_assign_b1 <- merge(x[,c("Barcode","Assignment","Assignment_Probability")], x_2[,c(2:4)], by="Barcode", all=TRUE)
barcode_assign_b1 <- merge(barcode_assign_b1, x_3[,c(2:4)], by="Barcode", all=TRUE)
colnames(barcode_assign_b1)[2:7] <- c("HumanRef_0.6","HumanRef_0.6_AssignProb","HumanRef_0.5","HumanRef_0.5_AssignProb","HumanRef_0.9","HumanRef_0.9_AssignProb")

#batch 1 using chimp reference
x <- read.csv("../scRNA/human_chimp_chondro_time_batch1_c_06/outs/multi/multiplexing_analysis/assignment_confidence_table.csv")
dim(x)
dplyr::count(x, Assignment)
x_2 <- cp_threshold_assignment(data=x, threshold=0.5)
dim(x_2)
...
barcode_assign_b1 <- merge(barcode_assign_b1, x_3[,c(2:4)], by="Barcode", all=TRUE)
colnames(barcode_assign_b1)[8:13] <- c("ChimpRef_0.6","ChimpRef_0.6_AssignProb","ChimpRef_0.5","ChimpRef_0.5_AssignProb","ChimpRef_0.9","ChimpRef_0.9_AssignProb")

#batch 1 using human-chimp combined reference
x <- read.csv("../scRNA/human_chimp_chondro_time_batch1_hc_06/outs/multi/multiplexing_analysis/assignment_confidence_table.csv")
dim(x)
dplyr::count(x, Assignment)
x_2 <- cp_threshold_assignment(data=x, threshold=0.5)
dim(x_2)
...
barcode_assign_b1 <- merge(barcode_assign_b1, x_2[,c(2:4)], by="Barcode", all=TRUE)
barcode_assign_b1 <- merge(barcode_assign_b1, x_3[,c(2:4)], by="Barcode", all=TRUE)
colnames(barcode_assign_b1)[14:19] <- c("ComboRef_0.6","ComboRef_0.6_AssignProb","ComboRef_0.5","ComboRef_0.5_AssignProb","ComboRef_0.9","ComboRef_0.9_AssignProb")

#batch 2 using human reference
x <- read.csv("../scRNA/human_chimp_chondro_time_batch2_h_06/outs/multi/multiplexing_analysis/assignment_confidence_table.csv")
dim(x)
dplyr::count(x, Assignment)
x_2 <- cp_threshold_assignment(data=x, threshold=0.5)
dim(x_2)
...
barcode_assign_b2 <- merge(barcode_assign_b2, x_3[,c(2:4)], by="Barcode", all=TRUE)
colnames(barcode_assign_b2)[2:7] <- c("HumanRef_0.6","HumanRef_0.6_AssignProb","HumanRef_0.5","HumanRef_0.5_AssignProb","HumanRef_0.9","HumanRef_0.9_AssignProb")

#batch 2 using chimp reference
x <- read.csv("../scRNA/human_chimp_chondro_time_batch2_c_06/outs/multi/multiplexing_analysis/assignment_confidence_table.csv")
dim(x)
dplyr::count(x, Assignment)
x_2 <- cp_threshold_assignment(data=x, threshold=0.5)
dim(x_2)
...
barcode_assign_b2 <- merge(barcode_assign_b2, x_3[,c(2:4)], by="Barcode", all=TRUE)
colnames(barcode_assign_b2)[8:13] <- c("ChimpRef_0.6","ChimpRef_0.6_AssignProb","ChimpRef_0.5","ChimpRef_0.5_AssignProb","ChimpRef_0.9","ChimpRef_0.9_AssignProb")

#batch 2 using human-chimp combined reference
x <- read.csv("../scRNA/human_chimp_chondro_time_batch2_hc_06/outs/multi/multiplexing_analysis/assignment_confidence_table.csv")
dim(x)
dplyr::count(x, Assignment)
x_2 <- cp_threshold_assignment(data=x, threshold=0.5)
dim(x_2)
...
barcode_assign_b2 <- merge(barcode_assign_b2, x_2[,c(2:4)], by="Barcode", all=TRUE)
barcode_assign_b2 <- merge(barcode_assign_b2, x_3[,c(2:4)], by="Barcode", all=TRUE)
colnames(barcode_assign_b2)[14:19] <- c("ComboRef_0.6","ComboRef_0.6_AssignProb","ComboRef_0.5","ComboRef_0.5_AssignProb","ComboRef_0.9","ComboRef_0.9_AssignProb")
...
Cell Assignments Singlets
* Batch 1: 31049 (vs. 33297 using human reference / 32182 using chimp reference)
* Batch 2:  5668 (vs.  4245 using human reference /  3693 using chimp reference)

```{r}

dim(barcode_assign_b1)
dplyr::count(barcode_assign_b1, HumanRef_0.6)
dplyr::count(barcode_assign_b1, ChimpRef_0.6)
dplyr::count(barcode_assign_b1, ComboRef_0.6)

dim(barcode_assign_b2)
dplyr::count(barcode_assign_b2, HumanRef_0.6)
dplyr::count(barcode_assign_b2, ChimpRef_0.6)
dplyr::count(barcode_assign_b2, ComboRef_0.6)
...
saveRDS(barcode_assign_b1, file="./data/06_cmo_barcode_assign_batch1.rds")
saveRDS(barcode_assign_b2, file="./data/06_cmo_barcode_assign_batch2.rds")
...
sample_tot <- c("H1_C1_d00","H1_C1_d0","H1_C1_m_d7","H1_C1_m_d14","H1_C1_c_d7","H1_C1_c_d14",
                ...
                "H5_C5_d0","H5_C5_c_d7","H5_C5_c_d14","H3_C2_d0","H3_C2_c_d7","H3_C2_c_d14")
...
while (i <= length(batch)) {
  ...
  dir <- paste0('./../scRNA/human_chimp_chondro_time_',batch[i],'_hc_06/outs/per_sample_outs/')
...
dplyr::count(spp,call)
#dplyr::count(spp,NEWcall)
...
saveRDS(spp, file="./data/06_spp_assign.rds")
...
sample_tot <- c("H1_C1_d00","H1_C1_d0","H1_C1_m_d7","H1_C1_m_d14","H1_C1_c_d7","H1_C1_c_d14",
                "H2_C4_d00","H2_C4_d0","H2_C4_m_d7","H2_C4_m_d14","H2_C4_c_d7","H2_C4_c_d14",
                "H5_C5_d0","H5_C5_c_d7","H5_C5_c_d14","H3_C2_d0","H3_C2_c_d7","H3_C2_c_d14")
spp <- readRDS(file="./data/06_spp_assign.rds")
...
while (i <= length(batch)) {
  ...
  #(0)define directory
    dir_h.data <- paste0('./../scRNA/human_chimp_chondro_time_',batch[i],'_h_06/outs/multi/count')
    dir_c.data <- paste0('./../scRNA/human_chimp_chondro_time_',batch[i],'_c_06/outs/multi/count')
  ...
  #(6)view details of species assignments
    print(table(h.dat@meta.data$Species, useNA="always"))
    print(table(c.dat@meta.data$Species, useNA="always"))
  ...
  #(8)create merged object
    ...
    saveRDS(h.c.dat.spp, file=paste0('./data/06_h.c.dat.spp.',batch[i],'.rds'))
...
for (i in 1:length(batch)) {
  print(i)
  data[[i]] <- readRDS(paste0("./data/06_h.c.dat.spp.",batch[i],".rds"))
}
...
barcode_assign_b1 <- readRDS("./data/06_cmo_barcode_assign_batch1.rds")
barcode_assign_b2 <- readRDS("./data/06_cmo_barcode_assign_batch2.rds")
...
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO301")] <- "H1+C1"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO302")] <- "H1+C1"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO303")] <- "H1+C1"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO304")] <- "H1+C1"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO305")] <- "H1+C1"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO306")] <- "H1+C1"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO307")] <- "H2+C4"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO308")] <- "H2+C4"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO309")] <- "H2+C4"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO310")] <- "H2+C4"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO311")] <- "H2+C4"
data[[1]]$Pair[which(data[[1]]$ComboRef_0.6=="CMO312")] <- "H2+C4"
data[[2]]$Pair[which(data[[2]]$ComboRef_0.6=="CMO301")] <- "H5+C5"
data[[2]]$Pair[which(data[[2]]$ComboRef_0.6=="CMO302")] <- "H5+C5"
data[[2]]$Pair[which(data[[2]]$ComboRef_0.6=="CMO303")] <- "H5+C5"
data[[2]]$Pair[which(data[[2]]$ComboRef_0.6=="CMO304")] <- "H3+C2"
data[[2]]$Pair[which(data[[2]]$ComboRef_0.6=="CMO305")] <- "H3+C2"
data[[2]]$Pair[which(data[[2]]$ComboRef_0.6=="CMO306")] <- "H3+C2"
...
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO301")] <- "d00"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO302")] <- "d0"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO303")] <- "d7-m"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO304")] <- "d14-m"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO305")] <- "d7-c"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO306")] <- "d14-c"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO307")] <- "d00"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO308")] <- "d0"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO309")] <- "d7-m"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO310")] <- "d14-m"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO311")] <- "d7-c"
data[[1]]$Stage[which(data[[1]]$ComboRef_0.6=="CMO312")] <- "d14-c"
data[[2]]$Stage[which(data[[2]]$ComboRef_0.6=="CMO301")] <- "d0"
data[[2]]$Stage[which(data[[2]]$ComboRef_0.6=="CMO302")] <- "d7-c"
data[[2]]$Stage[which(data[[2]]$ComboRef_0.6=="CMO303")] <- "d14-c"
data[[2]]$Stage[which(data[[2]]$ComboRef_0.6=="CMO304")] <- "d0"
data[[2]]$Stage[which(data[[2]]$ComboRef_0.6=="CMO305")] <- "d7-c"
data[[2]]$Stage[which(data[[2]]$ComboRef_0.6=="CMO306")] <- "d14-c"
...
#Save total data
saveRDS(data, file="./data/06_data.rds")
