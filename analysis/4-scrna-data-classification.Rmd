...
save(wu_combined_rev, file="./data/external/wu_combined_rev.rds")

```

Integrate current study data with Wu data
...
#save data
saveRDS(integrate, file=paste0("./data/integrated/combined-data-wu",filter,".log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
...
count_data_gah <- read.csv2("/project2/gilad/ghousman/skeletal-human-chimp/human-chimp-skeletal-scRNA/data/cellranger-data-full/GHO_count.csv")
meta_data_gah <- read.csv2("/project2/gilad/ghousman/skeletal-human-chimp/human-chimp-skeletal-scRNA/data/cellranger-data-full/GHO_meta.csv")

gah_data <- CreateSeuratObject(counts=count_data_gah, meta.data=meta_data_gah, project="gah")

for (i in 1:length(gah_data)) { gah_data[[i]]$ChondroStage <- NA }
for (i in 1:length(gah_data)) {
  gah_data[[i]]$ChondroStage[which(gah_data[[i]]$Cell.Type=="iPSC")]         <- "GH: iPSC"
  gah_data[[i]]$ChondroStage[which(gah_data[[i]]$Cell.Type=="MSC")]          <- "GH: Day 00"
  gah_data[[i]]$ChondroStage[which(gah_data[[i]]$Cell.Type=="Osteogenic")]   <- "GH: Osteo"
  gah_data[[i]]$ChondroStage[which(gah_data[[i]]$Cell.Type=="Chondrogenic")] <- "GH: Day 21*"
}

#### DO I NEED TO SUBSET DATA BY SPECIES??? ####
...
save(gah_data, file="./data/external/gah_data.rds")

```

Integrate current study data with pilot differentiation data
...
#save data
saveRDS(integrate, file=paste0("./data/integrated/combined-data-gah",filter,".log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".rds"))
