...
m.c1    <- rgb(186, 85,211, maxColorValue=255)
m.c2    <- rgb(218, 75,180, maxColorValue=255)
m.c3    <- rgb(253, 93, 93, maxColorValue=255)
c.c1    <- rgb(254,138, 46, maxColorValue=255)
c.c2    <- rgb(254,192,  0, maxColorValue=255)

cc.c1   <- rgb(253, 93, 93, maxColorValue=255)
cc.c2   <- rgb(254,126, 62, maxColorValue=255)
cc.c3   <- rgb(254,159, 31, maxColorValue=255)
cc.c4   <- rgb(254,192,  0, maxColorValue=255)
...
#Load data
scrna <- paste0("./data/integrated/combined-data-eb.filterC.log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".rds")
#scrna <- paste0("./data/integrated/combined-data-eb-human.filterC.log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".rds")
data <- readRDS(scrna)
...
#Load data
scrna <- paste0("./data/integrated/combined-data-wu.filterC.log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".rds")
#scrna <- paste0("./data/integrated/combined-data-wu-human.filterC.log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".rds")
data <- readRDS(scrna)
...
#Load data
#scrna <- paste0("./data/integrated/combined-data-gah.filterC.log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".rds")
scrna <- paste0("./data/integrated/combined-data-gah-chondro.filterC.log.chond-ind.int.",genes,".",dimred,".",kweigh,".",regout,".rds")
data <- readRDS(scrna)
