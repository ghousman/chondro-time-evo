...
#Save data
saveRDS(data.filter, file="./data/data.filterL.rds")
...
#Save data
saveRDS(data.filter, file="./data/data.filterC.rds")
...
data.filter <- readRDS("./data/data.filterL.rds")
...
data.filter <- readRDS("./data/data.filterC.rds")
