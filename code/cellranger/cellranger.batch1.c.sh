...
/project2/gilad/ghousman/cellranger/cellranger-7.0.0/bin/cellranger multi --id human_chimp_chondro_time_batch1_c \
                                                    								      --csv ./../chondro-time-evo/code/cellranger/cellranger.batch1.c.csv \
                                                    								      --localcores 12 \
                                                    								      --localmem 48
