...
#SBATCH --output=cellranger.batch1.hc.${1}.out
#SBATCH --error=cellranger.batch1.hc.${1}.err
#SBATCH --time=36:00:00
#SBATCH --partition=broadwl
#SBATCH --mem=48G
#SBATCH --tasks-per-node=12

/project2/gilad/kenneth/software/cellranger-7.0.0/bin/cellranger count --id human_chimp_chondro_time_batch1_hc \
